    ...
    <div class="rating" ref="ratingSwiper" >
      ...
      <div class="rating-pages">
        ...
        <div class="rating-list">
          <ul>
            <li class="rating-list-item" v-for="rat in rating" v-if="type==-1 || rat.rateType==type && flag && rat.text!='' ">
  ...
  export default{
    ...
    created(){
      ...
      axios.get("http://192.168.1.66:8080/api/ratings").then(res=>{
        ...
        that.nowRating=that.allRating;
        that.nowpartRating=that.nowRating;
        this.$nextTick(()=>{
